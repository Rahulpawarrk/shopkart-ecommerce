<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
            ...
            <div class="auth-page-wrapper">
                ...
                <div class="auth-card">
                    ...
                    <c:if test="${not empty demoOtp}">
                        <div
                            style="background: #fefce8; border: 1px solid #fde047; border-left: 4px solid #eab308; padding: 0.75rem 1rem; border-radius: var(--radius-sm); margin-bottom: 1.25rem; color: #854d0e; font-size: 0.85rem;">
                            <div style="font-weight: 700; margin-bottom: 0.25rem;">ℹ️ Demo Mode (SMTP Not Configured):
                            </div>
                            <div>Your 6-digit verification code is: <strong
                                    style="font-family: monospace; font-size: 1.15rem; color: #0f172a; background: #fff; padding: 2px 8px; border-radius: 4px; border: 1px solid #cbd5e1; letter-spacing: 2px;">
                                    <c:out value="${demoOtp}" />
                                </strong></div>
                        </div>
                    </c:if>
                    ...
                    <form action="${pageContext.request.contextPath}/verify-email" method="POST" id="verifyEmailForm">
                        ...
                        <button type="submit" id="verifySubmitBtn" class="hero-cta-btn"
                            style="width: 100%; text-align: center; justify-content: center; padding: 0.75rem; font-size: 1rem; margin-bottom: 1.25rem;">
            ...
            <script>
                // Clean numeric input only (NO auto-submit on typing)
                ...
                // Prevent double submission and show spinner only when user clicks the button
                if (verifyForm) {
