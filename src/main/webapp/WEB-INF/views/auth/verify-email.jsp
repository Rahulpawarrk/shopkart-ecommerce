...
<body>
    ...
    <div class="auth-page-wrapper">
        ...
        <div class="auth-card">
            <h1 style="font-size: 1.45rem; font-weight: 800; color: #111827; margin: 0 0 0.5rem;">
            ...
            <c:if test="${not empty error}">
                <div style="background: #fef2f2; border-left: 4px solid var(--danger); padding: 0.75rem 1rem; border-radius: var(--radius-sm); margin-bottom: 1.25rem; color: #991b1b; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.4rem;">
                    <span>⚠️</span>
            ...
            <c:if test="${not empty successMessage}">
                <div style="background: #f0fdf4; border-left: 4px solid var(--success); padding: 0.75rem 1rem; border-radius: var(--radius-sm); margin-bottom: 1.25rem; color: #166534; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.4rem;">
                    <span>✓</span>
            ...
            <form action="${pageContext.request.contextPath}/verify-email" method="POST" id="verifyEmailForm">
                <div style="margin-bottom: 1.25rem;">
                    ...
                    <input type="text" id="otp" name="otp" class="otp-input-field" maxlength="6" pattern="[0-9]{6}" placeholder="------" autocomplete="one-time-code" autofocus required>
                    <div style="font-size: 0.75rem; color: #64748b; margin-top: 0.4rem; display: flex; justify-content: space-between;">
                        <span>Code expires in 10 minutes</span>
                        <span id="countdownTimer" style="font-weight: 700; color: #0369a1;"></span>
                    </div>
                </div>

                <button type="submit" class="hero-cta-btn" style="width: 100%; text-align: center; justify-content: center; padding: 0.75rem; font-size: 1rem; margin-bottom: 1.25rem;">
                    Verify &amp; Create Account →
                </button>
            </form>

            <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #e2e8f0; padding-top: 1rem; font-size: 0.82rem;">
                <div>
                    <a href="${pageContext.request.contextPath}/verify-email?resend=true" id="resendBtn" style="color: #2563eb; font-weight: 700; text-decoration: none;">
                        🔄 Resend Code
                    </a>
                </div>
                <div>
                    <a href="${pageContext.request.contextPath}/register" style="color: #64748b; text-decoration: none;">
                        ✏️ Change Details
                    </a>
                </div>
            </div>
    ...
    <script>
        // Auto-format OTP field (digits only)
