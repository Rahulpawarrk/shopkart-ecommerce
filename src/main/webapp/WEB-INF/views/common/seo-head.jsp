                            ...
                            <%-- Open Graph / Facebook / WhatsApp --%>
                                ...
                                <c:if test="${seo.ogType == 'product' && not empty seo.productPriceAmount}">
                                    <meta property="product:price:amount"
                                        content="<c:out value='${seo.productPriceAmount}' />">
                                    <meta property="product:price:currency"
                                        content="<c:out value='${seo.productPriceCurrency}' />">
                                    <c:if test="${not empty seo.productAvailability}">
                                        <meta property="product:availability"
                                            content="<c:out value='${seo.productAvailability}' />">
                                    </c:if>
                                </c:if>
