...
<head>
    ...
    <title>404 - Page Not Found | E-Commerce Platform</title>
...
<body>
    ...
    <main class="container" style="text-align: center; padding-top: 4rem;">
        <div class="card" style="max-width: 600px; margin: 0 auto; padding: 3rem;">
            <div style="font-size: 4rem; color: var(--warning-color); margin-bottom: 1rem;">🔍</div>
            <h1 style="font-size: 2rem; margin-bottom: 0.5rem;">404 - Page Not Found</h1>
            <p style="color: var(--text-secondary); margin-bottom: 2rem;">
                The resource or endpoint you requested does not exist or has been moved.
            </p>
            <div>
                <a href="${pageContext.request.contextPath}/" class="btn btn-primary">Return to Homepage</a>
                <c:if test="${sessionScope.currentUser.admin}">
                    <a href="${pageContext.request.contextPath}/health" class="btn btn-secondary" style="margin-left: 0.5rem;">System Health</a>
                </c:if>
            </div>
        </div>
    </main>
